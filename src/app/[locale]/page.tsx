...
export default async function Home({
  ...
  // Load the prebuilt timeframe bundle (one fetch, one parse). The
  // bundle is generated by scripts/build-pulse.mjs at build time and
  // already contains 200-point thinned sparklines filtered to this
  // timeframe for every symbol in ASSETS.
